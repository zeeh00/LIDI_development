...
class KbnTobFragment : Fragment(), AnimalAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_kbn_tob, container, false)
    ...
    private fun fetchDataFromFirestore() {
        ...
        collectionReference.whereEqualTo("location", "TOB")
            .get()
    ...
    companion object {
        fun newInstance(): KbnTobFragment {
            return KbnTobFragment()
        }
    }
}